...
first_gear_entry = tkinter.Entry(gears_selection_frame, width= 2)
...
second_gear_entry = tkinter.Entry(gears_selection_frame, width= 2)
...
third_gear_entry = tkinter.Entry(gears_selection_frame, width= 2)
...
fourth_gear_entry = tkinter.Entry(gears_selection_frame, width= 2)
...
fifth_gear_entry = tkinter.Entry(gears_selection_frame, width= 2)
...
sixth_gear_entry = tkinter.Entry(gears_selection_frame, width= 2)
...
seventh_gear_entry = tkinter.Entry(gears_selection_frame, width= 2)
...
reverse_gear_entry = tkinter.Entry(gears_selection_frame, width= 2)
